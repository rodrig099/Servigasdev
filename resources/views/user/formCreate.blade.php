    ...
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="apellidos" class="form-control @error('apellidos') is-invalid @enderror"
                value="{{ old('apellidos', $user?->apellidos) }}" id="apellidos" placeholder="Apellidos">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="barrio" class="form-control @error('barrio') is-invalid @enderror"
                value="{{ old('barrio', $user?->barrio) }}" id="barrio" placeholder="Barrio">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="departamento" class="form-control @error('departamento') is-invalid @enderror"
                value="{{ old('departamento', $user?->departamento) }}" id="departamento" placeholder="Departamento">
