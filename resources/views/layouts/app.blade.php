        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ request()->is('solicitudes') ? 'active' : ''}} {{ request()->is('missolicitudes') ? 'active' : ''}}">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item {{ request()->is('missolicitudes') ? 'active' : ''}}">
                                <a href="{{ url('missolicitudes') }}" class="menu-link">
