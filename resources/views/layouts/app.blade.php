...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        @hasrole('Admin')
        <li class="menu-item {{ request()->is('facturas*') || request()->is('cotizaciones*') ? 'active' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <li class="menu-item {{ request()->is('instalaciones') ? 'active' : '' }}">
        ...
        <li class="menu-item {{ request()->is('file-manager') ? 'active' : '' }}">
            <a href="{{ url('file-manager') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-archive"></i>
